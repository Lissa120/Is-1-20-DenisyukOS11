...
namespace Is_1_20_DenisyukOS
{
    public partial class Notice : Form
    {
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT * FROM Notification";
        ...
        private void Notice_Load(object sender, EventArgs e)
        {
            ...
            guna2DataGridView1.Columns[8].Visible = true;
            guna2DataGridView1.Columns[9].Visible = true;
            //Ширина полей
            guna2DataGridView1.Columns[0].FillWeight = 10;
            guna2DataGridView1.Columns[1].FillWeight = 10;
            guna2DataGridView1.Columns[2].FillWeight = 30;
            guna2DataGridView1.Columns[3].FillWeight = 30;
            guna2DataGridView1.Columns[4].FillWeight = 35;
            guna2DataGridView1.Columns[5].FillWeight = 35;
            guna2DataGridView1.Columns[6].FillWeight = 15;
            guna2DataGridView1.Columns[7].FillWeight = 30;
            guna2DataGridView1.Columns[8].FillWeight = 40;
            guna2DataGridView1.Columns[9].FillWeight = 35;
            ...
            guna2DataGridView1.Columns[3].ReadOnly = true;
            guna2DataGridView1.Columns[4].ReadOnly = true;
            guna2DataGridView1.Columns[5].ReadOnly = true;
            guna2DataGridView1.Columns[6].ReadOnly = true;
            guna2DataGridView1.Columns[7].ReadOnly = true;
            guna2DataGridView1.Columns[8].ReadOnly = true;
            guna2DataGridView1.Columns[9].ReadOnly = true;
            ...
            guna2DataGridView1.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            ...
            guna2DataGridView1.Columns[7].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            guna2DataGridView1.Columns[8].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            guna2DataGridView1.Columns[9].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
